...
std::vector<std::vector<egr::EagerTensor>> GradNodeMatmul::operator()(
  ...
  if (GradientHooksRegistered()) {
    ...
    std::vector<paddle::experimental::Tensor> grad_tensors =
        paddle::experimental::grad_matmul(*x_tensor.get(), *y_tensor.get(),
                                          *hooked_grad.get(), transpose_x_,
                                          transpose_y_);
